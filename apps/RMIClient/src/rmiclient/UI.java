...
public class UI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("/");
        jButton1.setActionCommand("Divide");
        ...
        jButton2.setText("*");
        jButton2.setActionCommand("Multiply");
        ...
        jButton4.setText("-");
        jButton4.setActionCommand("Subtract");
        ...
        label1.setText("Enter number one");

        label2.setText("Enter number two");
